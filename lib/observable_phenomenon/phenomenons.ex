defmodule ValueFlows.Observe.ObservablePhenomenons do
  ...
  def create(user, observable_property_id, attrs)
      when is_binary(observable_property_id) do
  ...
  def create(user, %{id: observable_property_id}, attrs),
    do: create(user, observable_property_id, attrs)
