  ...
  describe "observable_phenomenon" do
    test "fetches an existing observable_phenomenon by ID" do
      ...
      assert_observable_phenomenon(
        grumble_post_key(q, conn, :observable_phenomenon, %{
          id: observable_phenomenon.id
        })
      )
    end
    ...
    test "creates a new observable_phenomenon" do
      ...
      vars = %{
        observable_phenomenon: observable_phenomenon_input(observable_property)
      }

      # |> IO.inspect()
      r = grumble_post_key(q, conn, :create_observable_phenomenon, vars)
    ...
    test "updates an existing observable_phenomenon" do
      ...
      vars = %{
        observable_phenomenon:
          Map.put(
            observable_phenomenon_input(observable_property, %{
              "note" => "updated"
            }),
            "id",
            observable_phenomenon.id
          )
      }

      # |> IO.inspect()
      r = grumble_post_key(q, conn, :update_observable_phenomenon, vars)
      assert_observable_phenomenon(r)
    end
    ...
    test "deletes an existing observable_phenomenon" do
      ...
      assert grumble_post_key(q, conn, :delete_observable_phenomenon, %{
               id: observable_phenomenon.id
             })
    end
